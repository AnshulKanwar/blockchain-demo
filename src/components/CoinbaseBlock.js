...
const Blockchain = () => {
  ...
  const [block1, setBlock1] = useState(generateNewBlockState(1, 436231));
  const [block2, setBlock2] = useState(generateNewBlockState(2, 460512));
  const [block3, setBlock3] = useState(generateNewBlockState(3, 817428));
  const [block4, setBlock4] = useState(generateNewBlockState(4, 996482));
  const [block5, setBlock5] = useState(generateNewBlockState(5, 40787));
